...
var View = React.createClass({displayName: "View",
	...
	componentDidMount: function() {
		...
		Object.keys(parentNode.attributes).forEach(function(key) {
			...
			if (parentNode.attributes[key].name && parentNode.attributes[key].name.substr(0, 2) === 'e-') {
				hasNextProps = true;
...
React.render(React.createElement(View, {orgSearch: false}), document.getElementById('header'));